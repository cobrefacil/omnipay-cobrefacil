...
class CreateSubscriptionRequestTest extends TestCase
{
    ...
    public function testCreateUsingInitialize()
    {
        ...
        $this->assertSame('2023-01-01', $data['first_due_date']);
    ...
    public function testCreateUsingSetters()
    {
        $item1 = (new SubscriptionItem())
            ->setProductsServicesId('Y1LOJWXR9LX5926K8Q70')
            ->setQuantity(2)
            ->setPrice(7500);
        $this->request->setFirstDueDate('2023-01-01');
    ...
    public function testSendSuccess()
    {
        ...
        $response = $this->request
            ...
            ->setCustomerId('N5YG0OV16ZED1EKX7M8Z')
            ->setGenerateDays(5)
            ->setIntervalType('month')
            ->setIntervalSize(1)
            ->setNotificationRuleId('52XD4W3GE1DZ97JM1R0K')
            ->send();
        $this->assertTrue($response->isSuccessful());
        $this->assertFalse($response->isRedirect());
        $this->assertSame($response->getId(), 'KWMZP7RVEQGD83D4Y5O9');
    ...
    public function testSendFailure()
    {
        ...
        $this->assertSame([
            'First due date deve ser uma data maior ou igual a today.',
        ], $response->getErrors());
    }
}
